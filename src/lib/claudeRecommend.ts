...
- Все идеи должны быть реально доступны для покупки в России, например на Яндекс Маркете. Если указан город, можно предложить впечатление или услугу в этом городе, но хотя бы половина идей должна быть товарами.
...
- searchQuery: короткий поисковый запрос на русском для поиска такого товара на Яндекс Маркете, 2–5 слов, без знаков препинания и без указания цены.
