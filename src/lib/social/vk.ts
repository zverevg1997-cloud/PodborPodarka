 ...
 *
 * Токенов у нас два, и они не взаимозаменяемы: сервисный ключ приложения
 * умеет читать чужие стены, но не умеет писать в нашу, а токен сообщества —
 * наоборот. Здесь нужен второй, VK_TOKEN.
 */
