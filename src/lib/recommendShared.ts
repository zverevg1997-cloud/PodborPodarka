...
- Строго укладывайся в бюджет в рублях. Если названа только верхняя граница, держись её верхней половины: подарок за шестьсот рублей при бюджете «до пятнадцати тысяч» выглядит так, будто бюджет не прочитали. Если бюджет не указан — средний уровень цен.
